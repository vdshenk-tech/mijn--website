...
photo_title_1: "Wannsee",
photo_text_1: "Olieverf op doek 50 x 70 cm",

photo_title_2: "De blik van de ander",
photo_text_2: "Olieverf op doek 50 x 70 cm",
...
introduction:
	...
	company_vat: "[BTW-NUMMER]",
        ...
        disclaimer_text_1:
            "De informatie op deze website wordt uitsluitend ter informatie verstrekt. Aan deze informatie kunnen geen rechten worden ontleend. Momenteel is deze website louter informatief, ter voorbereiding van de opstart van mijn activiteiten. Hebt u nu al een vraag? Stuur gerust een e-mail naar …",
        disclaimer_text_2:
...
"Christine C. completed her Visual Arts education in the higher degree, specializing in painting, in Sint-Truiden in 2017. In her artistic practice, she explores the interplay between observation, imagination and inner experience. She draws inspiration from nature, literature, social themes, philosophy and the spontaneous impressions that arise during the creative process.<br><br>Her paintings often originate from a story, as in the painting about <em>The Gaze of the Other</em>, but they may just as well begin with colour, form or intuition. Within her body of work, she moves between figuration and abstraction. A distinctive colour palette plays a central role: colour is used as a carrier of atmosphere, movement and meaning. C. works mainly with oil paint, a medium that allows her to bring depth, layering and vivid colour intensity into her work. <br><br>In her artistic development, she is inspired by artists such as Matisse, Cézanne, Kandinsky, Hilma af Klint and Raveel. Their approach to colour, composition, form and expression serves as an important reference in her own artistic search. For Chevalier, making art is an ongoing process of growth, in which creativity, innovation and research are central. She sees art as a universal language that can connect people, offer space for reflection and have a healing effect.<br><br>Enjoy the viewing!",
	...
	company_vat: "[VAT NUMBER]",
        ...
        disclaimer_title: "Disclaimer",
        disclaimer_text_1:
            "The information contained on this website is provided for informational purposes only. No rights may be derived from it. At present, this website is purely informational and is intended to prepare for the launch of my activities. Do you have a question yet? Feel free to send an email to …",
        disclaimer_text_2:
...
introduction:"L'art est intemporel et ouvre sur un autre monde. Il fait émerger quelque chose tout en laissant une part de mystère. Chaque spectateur vit l'art à sa manière.<br><br>" +
	...
	company_vat: "[NUMÉRO DE TVA]",
        ...
        disclaimer_text_1:
            "Les informations contenues sur ce site sont fournies à titre purement informatif. Aucun droit ne peut en être tiré. Actuellement, ce site est uniquement informatif et a été créé en préparation du lancement de mes activités. Avez-vous déjà une question ? N’hésitez pas à envoyer un e-mail à …",
        disclaimer_text_2:
...
company_vat: "[UST-IDNR.]",
        ...
        disclaimer_text_1:
            "Die auf dieser Website enthaltenen Informationen dienen ausschließlich zu Informationszwecken. Daraus können keine Rechte abgeleitet werden. Derzeit dient diese Website lediglich zu Informationszwecken und zur Vorbereitung der Aufnahme meiner Tätigkeit. Haben Sie schon eine Frage? Schreiben Sie gerne eine E-Mail an …",
        disclaimer_text_2:
